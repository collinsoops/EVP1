              ...
              <div class="w-full overflow-x-auto">
                <table class="w-full whitespace-no-wrap">
                  ...
                  >
				  	...
				  	<?php
					$id=2;
						$result = $conn->prepare("SELECT * FROM users WHERE (usertype_id= :id) AND (election_id=:el)");
						//$result->bindParam(':id', $id);
						//$result->execute();
						
$result->execute(array(':id'=>$id,':el'=>$el));
                        ...
                        <div class="flex items-center text-sm">
                          ...
                          >
                            <img
                              ...
                              src="../img/candidate/<?php echo $row['photo']; ?>"
                              alt=""
                              loading="lazy"
                            />
                            <div
                          ...
                          <div>
                            <p class="font-semibold"><?php echo $row['firstname']; ?> <?php echo $row['lastname']; ?></p>
					...
					?>
                      ...
                      <td class="px-4 py-3">
                        <div class="flex items-center space-x-4 text-sm">
                            ...
                            <a rel="facebox" href="editcandidate.php?id= <?php echo $row1['candidate_id']; ?>" >      <button
                         ...
                         <button
						   ...
						   id="<?php echo $row1['candidate_id']; ?>"  title="Click To Delete" name="delbutton"
